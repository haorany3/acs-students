...
public class RequestArea implements Request {
  ...
  public void process() {
    ...
    if (area != null) {
      ...
      // Usamos el visitante para obtener las puertas de acceso de esa área
      area.accept(visitor);  // Pasamos el visitante para recolectar las puertas

      // Obtener las puertas de acceso del visitante
      ArrayList<Door> doorsGivingAccess = visitor.getDoors();
